...
<body style="background-color: #1a1a1a; color: #fff; overflow-y: auto !important;">
    <?php $active_menu = 'search'; require_once __DIR__ . '/top_menu.php'; ?>
        ...
        document.getElementById('btn-search').addEventListener('click', async () => {
            ...
            json.data.forEach(s => {
                ...
                tr.innerHTML = `
                    ...
                    <td style="padding: 15px;"><a href="index.php?page=home&id=${s.id}" style="color:#2196f3; text-decoration:none; font-weight:bold;">${s.title}</a></td>
