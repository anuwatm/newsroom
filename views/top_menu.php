    ...
    <div class="app-header">
        <div class="header-left" style="display: flex; align-items: center;">
            ...
            <nav class="top-nav" style="display: flex;">
                ...
                <div class="nav-item">
                    <a href="index.php?page=rundown" class="nav-link" <?php echo $active_menu === 'rundown' ? 'style="color: #4caf50;"' : ''; ?>>Rundown</a>
                </div>
                <div class="nav-item">
                    <a href="index.php?page=assignment" class="nav-link" <?php echo $active_menu === 'assignment' ? 'style="color: #4caf50;"' : ''; ?>>
                        Assignment
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="index.php?page=admin">Program Data</a>
                        <a href="users.php">User Management</a>
                        <a href="departments.php">Department Management</a>
                        <a href="index.php?page=equipment">Equipment Management</a>
                        <a href="index.php?page=syslog" style="color:#ffb74d;">System Logs (Audit)</a>
                        <?php endif; ?>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div class="user-info-bar" style="display: flex; align-items: center; gap: 12px;">
            ...
            <a href="index.php?page=logout" class="btn-logout" title="Logout" style="margin-left: 16px; display: flex; align-items: center; gap: 6px; color: #f44336; text-decoration: none; font-size: 13px; font-weight: bold;">
